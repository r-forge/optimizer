...
problem (see @Grah75a), Greg Snow suggested using an R6class (@R6class), but there should
be simpler mechanisms that can be used here. ?? Can we use a specified environment?
