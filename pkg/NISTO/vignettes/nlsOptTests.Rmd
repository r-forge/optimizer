...
(nlsr?? in progress), the Jacobian is computed analytically if possible, and the residual
...
more accurate **numDeriv** approximation. Note that the complex step derivative (??ref) would
