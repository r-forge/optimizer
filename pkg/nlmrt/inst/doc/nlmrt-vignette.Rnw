...
We have not yet been able to successfully use the INRA package \code{nls2}. This
is quite a complicated package and is not installable as a regular \R package 
