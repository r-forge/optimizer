...
####################### for older package elements. Can we simplify?
...
as.data.frame.opm <- function(x, row.names = NULL, optional = FALSE, ...) {
...
##################################################################
## DID NOT WORK 
# summary.optimx <- summary.opm
# "coef.optimx" <- coef.opm
# "[.optimx" <- "[.opm]"
# as.data.frame.optimx <- as.data.frame.opm
