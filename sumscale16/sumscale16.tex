...
\begin{verbatim}
##                 p1        p2        p3        p4         value fevals
## nlminb   0.1910859 0.1858287 0.2032001 0.2296229  8.062194e+00     40
## Rcgmin   0.1912221 0.1859094 0.2032530 0.2296592  8.062239e+00   2237
## nlm      0.1925000 0.1866667 0.2037500 0.2300000  8.062829e+00     NA
## Rvmmin   0.1945455 0.1878788 0.2045455 0.2305455  8.064408e+00     37
## spg      0.2050000 0.1940741 0.2086111 0.2333333  8.085799e+00   1213
## ucminf   0.2379245 0.2135849 0.2214151 0.2421132  8.371136e+00      6
## L-BFGS-B        NA        NA        NA        NA 8.988466e+307     NA
## BFGS            NA        NA        NA        NA 8.988466e+307     NA
## CG              NA        NA        NA        NA 8.988466e+307     NA
##          gevals convergence  kkt1 kkt2 xtime
## nlminb        4           1 FALSE TRUE 0.004
## Rcgmin      136           1 FALSE TRUE 0.120
## nlm           3           0 FALSE TRUE 0.004
## Rvmmin        4           3 FALSE TRUE 0.004
## spg          11           0 FALSE TRUE 0.144
## ucminf        6           0 FALSE TRUE 0.000
...
## Rvmmin       12           0 TRUE TRUE 0.008
## spg          13           0 TRUE TRUE 0.068
## Rcgmin       12           0 TRUE TRUE 0.004
## CG           21           0 TRUE TRUE 0.000
## nlm          11           0 TRUE TRUE 0.004
## BFGS          9           0 TRUE TRUE 0.004
...
##          gevals convergence kkt1 kkt2 xtime
## Rvmmin       14           0 TRUE TRUE 0.008
## Rcgmin       10           0 TRUE TRUE 0.004
## spg          13           0 TRUE TRUE 0.072
...
\end{alltt}
\begin{verbatim}
## Times: with gradient = 0.075    using numerical approx.= 0.068
\end{verbatim}
\begin{alltt}
...
## hjn          4.605170e+02  23292     NA           0  TRUE  TRUE  1.356
## bobyqa       4.605170e+02  21493     NA           0  TRUE  TRUE 17.492
## hjkb         4.605170e+02  20414     NA           0  TRUE  TRUE  0.916
## nmkb         7.202616e+02   5045     NA           1  TRUE FALSE  4.980
## Nelder-Mead  7.439745e+02   5002     NA           1  TRUE FALSE  0.216
## Rtnmin       7.556838e+02      8      8           3  TRUE FALSE  0.128
## Rcgmin       7.557004e+02      7      2           0 FALSE FALSE  0.012
## lbfgs        7.557324e+02     NA     NA       -1001 FALSE FALSE  0.084
## lbfgsb3      7.557324e+02     30     30           0  TRUE FALSE  0.148
## Rvmmin       7.558641e+02     64      4           3  TRUE FALSE  0.020
## nlm          7.558641e+02     NA      2           0  TRUE FALSE  0.492
## nlminb       7.618772e+02     44     44           1 FALSE FALSE  0.196
## ucminf       7.713573e+02      8      8           0 FALSE FALSE  0.052
## spg          7.747860e+02   1033     11           0  TRUE FALSE  0.256
## BFGS        8.988466e+307     NA     NA        9999    NA    NA  0.004
## CG          8.988466e+307     NA     NA        9999    NA    NA  0.000
## L-BFGS-B    8.988466e+307     NA     NA        9999    NA    NA  0.004
...
\end{alltt}
\begin{verbatim}
## maximal eigensolution: Value= -205 in time  0.776
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## minimal eigensolution: Value= 205 in time  0.073
\end{verbatim}
\begin{alltt}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# \\\#\# Attaching package: 'optimx'}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# The following object is masked from 'package:optimrx':\\\#\# \\\#\#\ \ \ \  coef<-}}\begin{alltt}
...
## newuoa      0.5454545 0.2727273 0.1818182 0.5454545     67     NA
## hjn         0.5454545 0.2727273 0.1818182 0.5454545    233     NA
## bobyqa      0.5454545 0.2727273 0.1818182 0.5454545     44     NA
## hjkb        0.5454545 0.2727272 0.1818183 0.5454545    314     NA
## Nelder-Mead 0.5454941 0.2726901 0.1818157 0.5454545     76     NA
##             convergence kkt1  kkt2 xtime
## newuoa                0 TRUE FALSE 0.004
## hjn                   0 TRUE FALSE 0.008
## bobyqa                0 TRUE FALSE 0.000
## hjkb                  0 TRUE FALSE 0.012
## Nelder-Mead           0 TRUE FALSE 0.000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\end{alltt}
\begin{verbatim}
## iter:  0  f-value:  1.987376  pgrad:  0.7305851 
## iter:  10  f-value:  0.5454545  pgrad:  8.974414e-05
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## [1] 0.5454524 0.2727290 0.1818187
\end{verbatim}
\end{kframe}
\end{knitrout}
