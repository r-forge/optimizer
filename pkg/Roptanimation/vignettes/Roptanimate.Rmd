...
relevant parameter vectors are tried. However, we really only want to draw the polygon when we have 
...
When the optimization terminates, we can, moreover, redraw the polygons at will using the 
following code.
