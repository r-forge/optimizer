...
\end{alltt}
\begin{verbatim}
## Times: with gradient = 0.043    using numerical approx.= 0.045
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## maximal eigensolution: Value= -205 in time  0.287
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## minimal eigensolution: Value= 205 in time  0.041
\end{verbatim}
\begin{alltt}
...
## Rvmmin   0.5454545 0.2727273 0.1818182 0.5454545    155     19           0
## nlm      0.5454545 0.2727273 0.1818182 0.5454545     NA      6           0
## Rcgmin   0.5454545 0.2727273 0.1818182 0.5454545     19      9           0
## nlminb   0.5454546 0.2727272 0.1818182 0.5454545     11     10           0
## L-BFGS-B 0.5454545 0.2727273 0.1818181 0.5454545      7      7           0
##          kkt1  kkt2 xtime
## Rvmmin   TRUE FALSE 0.008
...
\end{alltt}
\begin{verbatim}
## iter:  0  f-value:  0.2726239  pgrad:  0.6230611
\end{verbatim}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in spg(st, ssum, project = proj.simplex): Unsuccessful convergence.}}\begin{alltt}
\hlkwd{cat}\hlstd{(}\hlstr{"Using project.simplex with spg: fmin="}\hlstd{,as}\hlopt{$}\hlstd{value,}\hlstr{" at \textbackslash{}n"}\hlstd{)}
\end{alltt}
\begin{verbatim}
## Using project.simplex with spg: fmin= 0.2726239  at
\end{verbatim}
\begin{alltt}
\hlkwd{print}\hlstd{(as}\hlopt{$}\hlstd{par)}
\end{alltt}
\begin{verbatim}
## [1] 0.3243719 0.4064126 0.2692155
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Rcgmin          32     15           0 TRUE FALSE 0.008
## ucminf          15     15           0 TRUE FALSE 0.020
