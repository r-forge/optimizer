...
where the R functions in the packages differ, with `ctrldefault.R` listing
...
are restricted to the `library()` statements. 
...
employ vectorized computations. `hjn` was included in `optimr` and `optimrx` to provide
