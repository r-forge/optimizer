...
x0 <- rep(2, sum(dimx))
z0 <- c(x0, rep(2, sum(dimlam)), pmax(10, 5-c(g(x0, 1), g(x0, 2), g(x0, 3)) ) )

funCER(z0, dimx, dimlam, dimw, grobj=grfullob, constr=g, grconstr=grfullg)
jacCER(z0, dimx, dimlam, dimw, heobj=hefullob, constr=g, grconstr=grfullg, heconstr=hefullg)



GNE.ceq(z0, dimx, dimlam, dimw, grobj=grfullob, heobj=hefullob, 
...
#-------------------------------------------------------------------------------
# (2) Example of GNE with 4 solutions(!)
#-------------------------------------------------------------------------------
...
GNE.ceq(z0, dimx, dimlam, dimw, grobj=grobj, heobj=heobj, 
