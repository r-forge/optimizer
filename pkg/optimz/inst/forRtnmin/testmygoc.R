...
print(cres1)
cat("with optimx\n")
creso1 <- optimx(x, genrose.f, genrose.g, lower=low, upper=up, control=list(all.methods=TRUE))
...
print(cres2)
cat("with optimx\n")
creso2 <- optimx(x, genrose.f, genrose.g, lower=low, upper=up, control=list(all.methods=TRUE))
print(summary(creso1, order=value))
