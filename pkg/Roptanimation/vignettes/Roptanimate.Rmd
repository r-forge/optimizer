...
There are a number of unconstrained optimization methods, and the \texttt{optimr} package lets
...
Let us try all the bounds-constrained methods in \texttt{opm} from package \texttt{optimr.
