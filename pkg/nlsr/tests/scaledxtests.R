...
anlsrxb1  <-  try(nlsrxb(eunsc, start=start1, trace=traceval, data= weeddata1))
print(anlsrxb1)

anlsrxb2  <-  try(nlsrxb(eunsc, start=start1, trace=traceval, data=weeddata2))
print(anlsrxb2)
...
print(anls01)
anlsr01  <-  try(nlsrxb(eunsc, start=suneasy, trace=traceval, data=weeddata1))
print(anlsr01)
...
anlsr02  <-  nlsrxb(eunsc, start=start1, trace=traceval, data=weeddata1)
print(anlsr02)
...
print(anls03)
anlsr03  <-  nlsrxb(escal, start=start1, trace=traceval, data=weeddata1)
print(anlsr03)

# cat("HARD start -- scaled")
# anls04  <-  try(nls(escal, start=st1scal, trace=traceval, data=weeddata1))
# print(anls04)
# anlsr04  <-  nlsrxb(escal, start=st1scal, trace=traceval, data=weeddata1)
# print(anlsr04)

cat("EASY start -- scaled")
anls05  <-  try(nls(escal, start=ssceasy, trace=traceval, data=weeddata1))
print(anls05)
anlsr05  <-  nlsrxb(escal, start=ssceasy, trace=traceval, data=weeddata1)
print(anlsr05)
