...
It is often convenient to be able to run multimple optimization methods on the same function and 
gradient. To this end, the function `opm()` is supplied. The output of this by default includes
...
the objective function has specific properties. That is, according to the documentation:
     ...
     This method requires that the function be able to
