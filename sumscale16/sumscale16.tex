...
\end{alltt}
\begin{verbatim}
## Times: with gradient = 0.046    using numerical approx.= 0.04
\end{verbatim}
\begin{alltt}
...
this seems to carry over to cases with more parameters.
...
\end{alltt}
\begin{verbatim}
## Times: with gradient = 0.055    using numerical approx.= 0.042
\end{verbatim}
\begin{alltt}
