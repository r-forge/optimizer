...
\date{July 2012, with minor update December 2016}
\maketitle
...
TODOS:??
 ...
 - cleanup spg runs and explain better
 
 - check for similar disorganized sections
 
 - nice to have prescriptive section on "how to"
...
legend(150,(0.67*max(ti)),c("interpreted","byte compiled"), pch = c(1,3))
@
...
legend(150,0.67*max(c(eigen, spg, rcgmin)),c("spg", "rcgmin","eigen"), pch = c(1,3,4))
@
