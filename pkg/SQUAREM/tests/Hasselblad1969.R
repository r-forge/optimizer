...
# First-order SQUAREM algorithm with SqS3 method
  ...
  if (1e-12 < max(abs(good - pf2$par))) stop("error in First-order SQUAREM algorithm with SqS3 method.")
...
# First-order SQUAREM algorithm with SqS2 method
  ...
  if (1e-12 < max(abs(good - pf3$par))) stop("error in First-order SQUAREM algorithm with SqS2 method.")
...
# Note: the objective function is not evaluated when objfn.inc = Inf 
  ...
  good <- c(0.640114475404004, 2.663404513995809, 1.256095320343123)
  if (1e-12 < max(abs(good - pf4$par))) stop("error in First-order SQUAREM algorithm with SqS3 method; non-monotone.")
...
# First-order SQUAREM algorithm with SqS3 method; objective function is not specified
  ...
  good <- c(0.640114475404004, 2.663404513995809, 1.256095320343123)
  if (1e-12 < max(abs(good - pf5$par))) stop("error in First-order SQUAREM algorithm with SqS3 (and no objective function).")
...
# Second-order (K=2) SQUAREM algorithm with SqRRE 
  ...
  if (1e-12 < max(abs(good - pf6$par))) stop("error in Second-order (K=2) SQUAREM algorithm with SqRRE.")
...
# Second-order SQUAREM algorithm with SqRRE; objective function is not specified
  ...
  if (1e-12 < max(abs(good - pf7$par))) stop("error in Second-order SQUAREM algorithm with SqRRE (and no objective function).")
