...
- functions in nlsr-package.R need to be explained
...
- weights should possibly be available in nlxb. For nlfb, they can
  be added via the functions for residual and jacobian.??
- solution object is of class nlmrt. If we change to nlsr, should
  this be changed??
...
#### model2rjfun, model2ssgrfun, modelexpr, modeldoc
...
wssdoc <- modeldoc(wss) # ?? doesn't work. Why?
print(wssdoc)
```
...
#### newSimplification, Simplify, sysSimplifications, isFALSE, isZERO, isONE, isMINUSONE, isCALL, findSubexprs, sysDerivs
