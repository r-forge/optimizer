...
\end{alltt}
\begin{verbatim}
## Times: with gradient = 0.043    using numerical approx.= 0.04
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## Times: with gradient = 0.057    using numerical approx.= 0.041
\end{verbatim}
\begin{alltt}
...
\begin{verbatim}
##             value fevals gevals convergence  kkt1  kkt2 xtime
## Rvmmin   460.5170    398    272           2  TRUE  TRUE 0.656
## spg      460.5170    230    212           0  TRUE  TRUE 0.436
## Rcgmin   460.5170   1612   1023           0  TRUE  TRUE 1.828
## nlm      460.5170     NA    203           0  TRUE  TRUE 0.644
## L-BFGS-B 460.5170    280    280           0  TRUE  TRUE 0.488
## nlminb   482.2372    189    151           1 FALSE FALSE 0.328
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\end{alltt}
\begin{verbatim}
## maximal eigensolution: Value= -205 in time  0.285
\end{verbatim}
\begin{alltt}
...
## L-BFGS-B 0.5454545 0.2727273 0.1818182 0.5454545     10     10           0
## spg      0.5454545 0.2727273 0.1818182 0.5454545     11      9           0
## Rvmmin   0.5454545 0.2727273 0.1818182 0.5454545     28     12           0
## nlminb   0.5454545 0.2727273 0.1818182 0.5454545     11     10           0
## nlm      0.5454545 0.2727273 0.1818182 0.5454545     NA      9           0
##          kkt1  kkt2 xtime
...
\end{alltt}
\begin{verbatim}
## iter:  0  f-value:  0.6578874  pgrad:  0.5506649 
## iter:  10  f-value:  0.5454545  pgrad:  8.369971e-06
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## [1] 0.5454538 0.2727263 0.1818198
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Given the relatively limited experience above, it is nevertheless incumbent on us to 
recommend to \R users how to approach these problems. 

\subsection{Application of the ideas}
...
Moreover we can work with logarithms of parameters to avoid non-positive inputs to the objective function.


\begin{knitrout}\scriptsize
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{enew} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{lx}\hlstd{)\{}
  \hlstd{n} \hlkwb{<-} \hlkwd{length}\hlstd{(lx)}
  \hlstd{x} \hlkwb{<-} \hlkwd{exp}\hlstd{(lx)}
  \hlstd{scale} \hlkwb{<-} \hlkwd{sum}\hlstd{( (}\hlnum{1}\hlopt{:}\hlstd{n)} \hlopt{*} \hlstd{x}\hlopt{^}\hlnum{2}\hlstd{)}
  \hlstd{obj} \hlkwb{<-} \hlkwd{log}\hlstd{(scale)} \hlopt{-} \hlkwd{sum}\hlstd{(}\hlkwd{log}\hlstd{(x))}
\hlstd{\}}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\hlstd{lo} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlkwd{rep}\hlstd{(}\hlopt{-}\hlnum{100}\hlstd{, (n}\hlopt{-}\hlnum{1}\hlstd{)),strt[n])}
\hlstd{up} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlkwd{rep}\hlstd{(}\hlnum{100}\hlstd{, (n}\hlopt{-}\hlnum{1}\hlstd{)),strt[n])}
\hlstd{amsk2} \hlkwb{<-} \hlkwd{opm}\hlstd{(strt, enll, enll.g,} \hlkwc{lower}\hlstd{=lo,} \hlkwc{upper}\hlstd{=up,} \hlkwc{method}\hlstd{=mmth)}
\end{alltt}
...
\begin{verbatim}
##               p1        p2        p3        p4  p5   value fevals gevals
## Rvmmin 0.5000000 0.5000000 0.5000000 0.5000000 0.5 8.04719     25      8
## Rcgmin 0.4999991 0.4999985 0.4999984 0.4999987 0.5 8.04719     23     10
##        convergence kkt1  kkt2 xtime
## Rvmmin           0 TRUE FALSE 0.004
## Rcgmin           0 TRUE FALSE 0.004
\end{verbatim}
...
\hlstd{parm2} \hlkwb{<-} \hlstd{parm2}\hlopt{/}\hlkwd{sqrt}\hlstd{(}\hlkwd{scale}\hlstd{(parm2))}
\hlkwd{print}\hlstd{(parm2)}
\end{alltt}
\begin{verbatim}
##         p1  p2  p3  p4  p5
## Rvmmin NaN NaN NaN NaN NaN
\end{verbatim}
\end{kframe}
\end{knitrout}
