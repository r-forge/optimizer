...
ans1 <- BB:::dfsane(par=p0, fn=ccreact, method=1)
ans2 <- BB:::dfsane(par=p0, fn=ccreact, method=2)
ans3 <- BB:::sane(par=p0, fn=ccreact, method=1)
ans4 <- BB:::sane(par=p0, fn=ccreact, method=2)
...
ans1 <- BB:::dfsane(par=p0, fn=ccreact, method=1)
ans2 <- BB:::dfsane(par=p0, fn=ccreact, method=2, control = list(NM=TRUE))
ans3 <- BB:::sane(par=p0, fn=ccreact, method=1)
ans4 <- BB:::sane(par=p0, fn=ccreact, method=2)
