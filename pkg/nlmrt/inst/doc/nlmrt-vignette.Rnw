...
ans2i <- nlfb(start1, hobbs.res, hobbs.jac, 
...
ansma <- nlfb(start1, hobbs.res, hobbs.jac, maskidx=c(3,1,2))
ansma
# Bounds and mask
...
a1vm
## No jacobian - use internal approximation
a1cgn <- Rcgmin(start1, hobbs.f)
a1cgn
a1vmn <- Rvmmin(start1, hobbs.f)
a1vmn
# But 
...
a1vmn <- Rvmmin(start1, hobbs.f, gr="grfwd")
a1vmn
# Bounds -- infeasible start
