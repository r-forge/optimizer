...
t10k<-system.time(ans<-Rcgmin(xx,genrose.f,genrose.g0,control=list(trace=1),gs=100.0))[1]
...
ll<-rep(-20,1000)
uu<--ll
t1000m<-system.time(ans<-Rcgmin(xx,genrose.f,genrose.g0,lower=ll, upper=uu,bdmsk=bdmsk,control=list(trace=1),gs=100.0))[1]
cat("final fn value =",ans$value,"\n")
cat("time = ",t1000m,"\n")
