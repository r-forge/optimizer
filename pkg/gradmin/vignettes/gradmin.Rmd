...
above, that is, in choosing the components SRCHDIRN and GETSTEP. There will be some choices
...
The vignette (??snewton package) discusses the development of some safeguarded variants of Newton methods for 
