...
Gauss2.formula <- ( y ~ b1*exp( -b2*x ) + b3*exp( -(x-b4)**2 / b5**2 ) +
           b6*exp( -(x-b7)**2 / b8**2 ) )

#- setup

library("NISTnls", character.only=TRUE)
mypdata <- eval(parse(text=data("Gauss2")))
...
names(start1)<-c("b1","b2","b3","b4","b5","b6","b7","b8")

start2<-c(94.0, 0.0105,   99.0,  63.0, 25.0,  71.0, 180.0, 20.0)
names(start2)<-c("b1","b2","b3","b4","b5","b6","b7","b8")
